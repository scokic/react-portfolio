...
const DevToolsSection = () => {
  ...
  const devToolsList = devTools.map((tool, idx) => (
    <DevToolCard
      key={idx}
      idx={idx}
      name={tool.name}
    ...
    <div className="dev-tools-wrapper section-wrapper">
      <div className="dev-tools-container section-container">
        ...
        <p className="section-description">
          These are the tools I love using. Hover over tools check out what I
          admire and love using from each and every one of them!
        </p>
